...
csv_file = "Databases/resources/allworlddata.csv"
wp_df = pd.read_csv(csv_file)

conn1 = create_engine("sqlite:///Databases/resources/allworlddata.sqlite")
conn2 = create_engine("sqlite:///Databases/resources/population.sqlite")
